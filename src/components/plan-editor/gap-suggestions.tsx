...
/**
 * The Week view's fix for an untrained muscle, shown in a sheet over it: library moves that
 * target it (primary first), then a day to add the chosen one to. Adding goes through the editor's normal `addRow`, so it
...
export function GapSuggestions({
  ...
  /** Called after a move is added — the sheet closes. */
  onDone: () => void
}) {
