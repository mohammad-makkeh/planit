...
// Public and unauthenticated, like the share page — always drawn from the current plan.
export const dynamic = 'force-dynamic'
export const runtime = 'nodejs'

/** `/p/<slug>/story/<design>/<day index>?date=YYYY-MM-DD` → a 1080×1920 story card PNG. */
export async function GET(
  ...
  return new ImageResponse(
    ...
    { ...STORY, fonts: await storyFonts, headers: { 'cache-control': 'no-store' } },
  )
}
